...
func (rcv *Func) MutateRuntime(n byte) bool {
	return rcv._tab.MutateByteSlot(6, n)
}

func (rcv *Func) Source() []byte {
...
func (rcv *Func) Author(j int) []byte {
...
func (rcv *Func) AuthorLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(14))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
func (rcv *Func) Version(j int) []byte {
...
func (rcv *Func) VersionLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(18))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
func FuncAddRuntime(builder *flatbuffers.Builder, runtime byte) {
	builder.PrependByteSlot(1, runtime, 0)
}
func FuncAddSource(builder *flatbuffers.Builder, source flatbuffers.UOffsetT) {
...
func FuncStartAuthorVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
...
func FuncStartNameVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
...
func FuncStartVersionVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
